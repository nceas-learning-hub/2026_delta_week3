...
![](images/git_advanced_git_github/positron-01_start.png){fig-alt="Screen capture of Positron" .lightbox}
...
![](images/git_advanced_git_github/post-branch_positron-02_switch-dest.png){fig-alt="Screenshot of the Git operations dropdown menu in Positron" fig-align="center" width="80%" .lightbox}
...
![](images/git_advanced_git_github/post-branch_rstudio-03_pull-main.png){fig-alt="Screenshot of the Git message in RStudio when switching branches" fig-align="center" width="80%" .lightbox}
...
![](images/git_advanced_git_github/post-branch_positron-05_confirm-prune.png){fig-alt="Screenshot of the Git branch dropdown menu in Positron" fig-align="center" width="80%" .lightbox}
...
![](images/git_advanced_git_github/post-branch_rstudio-04_confirm-prune.png){fig-alt="Screenshot of the Git branch dropdown menu in RStudio" fig-align="center" width="50%" .lightbox}
...
What if you make a commit that you want to _undo_ (i.e., remove from your repository's history)? Git offers a command known as a "reset" to undo commits. There are three levels of severity to a reset; click through the tabs below for more details on each.

:::{.callout-note icon="false"}
### When a Reset is Warranted

If you want to undo a commit for merely cosmetic reasons, consider just leaving it as-is, but if you commit sensitive information or large files, undoing a commit can be a useful solution.
:::
