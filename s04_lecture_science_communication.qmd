...
![](images/lecture_science_communication/message_box.png){fig-alt="Blue square labled 'issue' surrounded by four facets labeled 'problems?', 'so what?', 'solutions?', and 'benefits?' (clockwise from top)" fig-align="center" width="75%".lightbox}
...
![](images/lecture_science_communication/message_box_qs.png){fig-alt="Blue square labled 'issue' surrounded by four facets labeled 'problems?', 'so what?', 'solutions?', and 'benefits?' (clockwise from top). Orange questions pertinent to each facet are written next to each facet title (questions are recapitulated by the text in the tabs above)" fig-align="center" width="75%".lightbox}
