...
Quarto is a popular tool for making websites easily customizable websites and these sites can be hosted through GitHub without much additional effort. These websites are free and can be a (relatively) easy way of making a central home for a given project to share core information with external partners.

The goal of this lesson is to get you started by working through the fundamental setup steps of creating your own Quarto website. This topic has _a lot_ of depth so we won't be able to cover everything today, but hopefully it is still a useful primer on this topic!
...
![](images/branch-01.png){fig-alt="Screenshot of the top of a GitHub repository's landing page" .lightbox}

### 2. Start Creating a New Branch

In the resulting page, **click the "New Branch" button** in the top right corner.

![](images/branch-02.png){fig-alt="Screenshot of the page in a GitHub repostiory where all active branches can be viewed" .lightbox}
...
![](images/branch-03.png){fig-alt="Screenshot of the pop-up window where new branches are named before they are created" width="50%" fig-align="center" .lightbox}
...
![](images/branch-04.png){fig-alt="Screenshot of the page in a GitHub repostiory where all active branches can be viewed" .lightbox}
...
![](images/branch-05.png){fig-alt="Screenshot of the top of a GitHub repository's landing page" .lightbox}
...
website:
  ...
  page-footer: 
    center: "Copyright &copy; 2026, LTER Network" # <4>
...
Once you have that file, **change the two lines that link to a GitHub repository to link to your website's repository.**
