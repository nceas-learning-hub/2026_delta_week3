...
Note, the optional `www` folder MUST be called `www` - this is where Shiny looks for static elements to be rendered in the app, but that are not products of the scripts, like images.  When you add an image to your app, you skip the `www` part in the file path - e.g., `img(src = 'my_image.png')`.
