...
::: column-margin
![](images/shiny_introduction/shiny-hex.png){width="70%" fig-align="center"}
:::
...
![Source: Intro to Shiny - EDS 430, Bren School UCSB](images/shiny_introduction/basic_shiny_app.png){width="70%" .lightbox fig-align="center"}
...
![](images/shiny_introduction/basic-widgets.png){width="70%" .lightbox fig-align="center"}
...
![Source: Intro to Shiny - EDS 430, Bren School UCSB](images/shiny_introduction/reactivity-intro.png){width="70%" .lightbox fig-align="center"}
...
![](images/shiny_introduction/shiny-yolo-app-part-1.png){width="70%" .lightbox fig-align="center"}
...
![](images/shiny_introduction/shiny-yolo-app-part-2.png){width="70%" .lightbox fig-align="center"}
...
![Source: Intro to Shiny - EDS 430, Bren School UCSB](images/shiny_introduction/one-vs-two.png){width="70%" .lightbox fig-align="center"}
...
In the single-file app, everything before starting the `ui` definition is a good candidate for `global.R`.  Below includes all the same information, plus station locations we'll use to build on the simple one-file app.
...
<div style="font-family: monospace; font-size: 0.8rem;">
{{< fa brands r-project >}} yolo_bypass_app/  
 ├── {{< fa file-code >}} **global.R**           _packages + data (runs first, available everywhere)_  
 ├── {{< fa file-code >}} **ui.R**               _user interface definition_  
 ├── {{< fa file-code >}} **server.R**           _server logic_  
 ├── {{< fa folder >}} **text/**  _(optional) text elements for UI)_  
...
![](images/shiny_introduction/shiny-yolo-app-tabbed-about.png){width="70%" .lightbox fig-align="center"}

#### Explore page

![](images/shiny_introduction/shiny-yolo-app-tabbed-data.png){width="70%" .lightbox fig-align="center"}
